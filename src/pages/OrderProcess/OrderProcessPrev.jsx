  ...
  return (
    <>
      <div className='pt-4 pb-1' style={{boxShadow: '0 3px 3px rgba(0, 0, 0, 0.5)', marginBottom: '3px'}}>
        <p className='text-center fs-6 fw-bold' style={{color: '#B31312'}}>Pemrosesan Pesanan</p>
      </div>
      <div className='filter-buttons d-flex justify-content-around mt-3 mb-0'>
        <button onClick={() => setActiveFilter('kemas')} style={activeFilter === 'kemas' ? { ...buttonStyle.common, ...buttonStyle.active } : { ...buttonStyle.common, ...buttonStyle.inactive }}>Kemas</button>
        <button onClick={() => setActiveFilter('kirim')} style={activeFilter === 'kirim' ? { ...buttonStyle.common, ...buttonStyle.active } : { ...buttonStyle.common, ...buttonStyle.inactive }}>Kirim</button>
                  ...
                  <div className='card-body d-flex justify-content-between align-items-center p-0 ps-3'>
                    ...
                    {activeFilter === 'kemas' && (
                      <div className='d-flex justify-content-between align-items-center'>
                        <button onClick={() => handleKemasAction(product._id)} className="btn btn-sm fw-bold text-white" style={{ backgroundColor: '#B31312', fontSize: '10px', width: '70px' }}>
              ...
              <div className='row g-0 d-flex align-items-center'>
                ...
                <div className='col-md-10'>
                  <div className='card-body d-flex justify-content-between align-items-center p-0 ps-3'>
                    ...
                    {activeFilter === 'kirim' && (
                      <div className='d-flex justify-content-between align-items-center'>
                        <button onClick={() => handleKirimAction(product._id)} className="btn btn-sm fw-bold text-white" style={{ backgroundColor: '#B31312', fontSize: '10px', width: '70px' }}>
